...
(tsales3a = ts(sales, start=c(2017, 6), frequency=12)) # years 2017 to 2018, 24 values, monthwise 24 observations spread to 2 years

# different start month
ts(sales, start=c(2017,3), end=c(2017,6), frequency=12)
?ts
...
#passengers travel data - seasonal data
AirPassengers  
